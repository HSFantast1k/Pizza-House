...
async def load_description(message: types.Message, state: FSMContext):
    if message.from_user.id == ID:
        ...
        await FSMAdmin.next()
        return await message.reply("Тепер укажи цену")


"""
Ловим последний ответ и используем полученные данные, записываем их
...
"""
@dp.callback_query_handler(lambda x: x.date and x.date.startswith('del '))
"""
